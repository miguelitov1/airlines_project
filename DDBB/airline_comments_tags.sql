...
CREATE TABLE `comments_tags` (
  ...
  KEY `tag_id` (`tag_id`),
  CONSTRAINT `comments_tags_ibfk_1` FOREIGN KEY (`comment_id`) REFERENCES `comments` (`id`) ON DELETE CASCADE,
  CONSTRAINT `comments_tags_ibfk_2` FOREIGN KEY (`tag_id`) REFERENCES `tags` (`id`) ON DELETE CASCADE
...
INSERT INTO `comments_tags` VALUES (1,1),(1,2),(2,3),(7,3),(2,4),(4,5),(5,6),(5,7),(7,8),(8,9),(9,10),(10,11),(10,12),(11,13);
